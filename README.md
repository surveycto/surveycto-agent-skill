...
| `assets/transcribe-translate/` | Runtime scripts for the OpenAI translate/transcribe workflows (`setup_env`, `openai_auth`, `translation`, `transcription`, `usage_ledger`) |
